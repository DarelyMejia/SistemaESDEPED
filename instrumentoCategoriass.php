...
$where = "";
$idInstrumentosRubros = $_GET['id'];

$sql = "SELECT * FROM instrumentosrubros WHERE idInstrumentosRubros = '$idInstrumentosRubros'";
$resultado = $mysqli->query($sql);
$row = $resultado->fetch_array(MYSQLI_ASSOC);


$where = "WHERE instrumento.idInstrumento = '$idInstrumentosRubros' AND instrumentosrubros.idInstrumentosRubros= '$idInstrumentosRubros'";
$sql2 = "SELECT instrumentosrubros.nombreInstrumentosRubros FROM instrumento NATURAL JOIN instrumentosrubros $where";
$resultado2 = $mysqli->query($sql2);
$insidnew1 = mysqli_fetch_assoc($resultado2);
$nombreInstrumentosRubros = $insidnew1["nombreInstrumentosRubros"];


$where3 = "WHERE instrumento.idInstrumento = '$idInstrumentosRubros' AND instrumentosrubros.idInstrumentosRubros= '$idInstrumentosRubros'";
$sql3 = "SELECT instrumento.nombre_Instrumento FROM instrumento NATURAL JOIN instrumentosrubros $where3";
$resultado3 = $mysqli->query($sql2);
$insidnew3 = mysqli_fetch_assoc($resultado3);
$nombreInstrumento = $insidnew1["nombre_Instrumento"];
...
if (!empty($_POST)) {
    $valor = $_POST['campo'];
    if (!empty($valor)) {
        $where4 = "WHERE nombreCategorias LIKE '%$valor%' AND idInstrumentosRubros  ='$idInstrumentosRubros'";
    }
}
$sql4 = "SELECT * FROM categorias $where4";
$resultado4 = $mysqli->query($sql4);

//Mostrar categorias cuyo idinstrumentoRuros = id recuperado del rubro seleccionado de la convocatoria
$sql4 = "SELECT * FROM categorias WHERE idInstrumentosRubros='$idInstrumentosRubros'";
$resultado4 = $mysqli->query($sql4);

//LISTA INSTRUMENTO SELECT. Mostrar instrumento cuyo id sea el recuperado del instrumento de la convocatoria
$sql = "SELECT idInstrumentosRubros, nombreInstrumentosRubros FROM instrumentosrubros where idInstrumentosRubros='$idInstrumentosRubros'";
...
<head>
    ...
    <script type="text/javascript">
        ...
        window.Muse.assets = {
            "required": ["museutils.js", "museconfig.js", "jquery.watch.js", "require.js", "instrumentocategorias.css"],
            "outOfDate": []
        };
    </script>

    <title>instrumentoCategorias</title>
    <!-- CSS -->
    <link rel="stylesheet" type="text/css" href="css/site_global.css?crc=3968863445" />
    <link rel="stylesheet" type="text/css" href="css/master_master-secretaria.css?crc=517575059" />
    <link rel="stylesheet" type="text/css" href="css/instrumentocategorias.css?crc=305719461" id="pagesheet" />
</head>
...
<body>
    ...
    <div class="clearfix" id="page">
        ...
        <div class="position_content" id="page_position_content">
            ...
            <div class="browser_width colelem" id="u3682-bw">
                <div id="u3682">
                    ...
                    <div class="clearfix" id="u3682_align_to_page">
                        <div class="clearfix grpelem" id="u4921-4">
                            <!-- content -->
                            <p>Instrumento</p>
                        </div>
                    </div>
            ...
            <div class="clearfix colelem" id="u4923-4">
                <!-- content -->
                <p><?php echo ''.$nombreInstrumento ?></p>
            </div>
            <form class="form-horizontal" method="POST" action="guardar_Categoria.php" autocomplete="off">
                <div class="colelem" id="u4922">
                    <!-- custom html -->
                    <select name="nombreInstrumentosRubros" class="btn btn-danger dropdown-toggle" size="0" id="nombreInstrumentosRubros">
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<option value=" . $row["nombreInstrumentosRubros"] . ">" . $row["nombreInstrumentosRubros"] . "</option>";
                            }
                        } else {
                ...
                <div class="clearfix colelem" id="pu4931-4">
                    <!-- group -->
                    <div class="clearfix grpelem" id="u4931-4">
                        <!-- content -->
                        <p>Categoría</p>
                    </div>
                    <div class="grpelem" id="u4929">
                        <!-- custom html -->
                        <input type="text" class="form-control" name="nombreCategorias" id="nombreCategorias" required>
                        <input type="text" class="form-control" name="idInstrumentosRubros" id="idInstrumentosRubros" value="<?php echo ''.$idInstrumentosRubros ?>" required>
                    </div>
                </div>
                <div class="clearfix colelem" id="pu4930-4">
                    <!-- group -->
                    <div class="clearfix grpelem" id="u4930-4">
                        <!-- content -->
                        <p>Puntaje</p>
                    </div>
                    <div class="grpelem" id="u4928">
                        <!-- custom html -->
                        <input type="number" min="1" class="form-control" name="puntosCategorias" id="puntosCategorias" required>
                    </div>
                </div>
                <div class="Button rounded-corners clearfix colelem" id="buttonu4925">
                    <button type="submit" class="Button rounded-corners clearfix colelem" id="buttonu4711">
                        <!-- container box -->
                        <div class="clearfix grpelem" id="u4926-4">
                            <!-- content -->
            ...
            <div class="colelem" id="u4924">
                <!-- custom html -->
                <div style="text-align: right;">
                    <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
                        <b></b><input class="form-control" type="text" id="campo" name="campo" />
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <?php while ($row = $resultado4->fetch_array(MYSQLI_ASSOC)) { ?>
                                <tr>
                                    <td>
                                        <?php echo $row['idCategorias']; ?>
                                    </td>
                                    <td>
                                        <?php echo $row['nombreCategorias']; ?>
                                    </td>
                                    <td>
                                        <?php echo $row['puntosCategorias']; ?>
                                    </td>
                                    <td>
                                        <?php echo $row['idInstrumentosRubros']; ?>
                                    </td>
                                    <td><a href="instrumento-subcategoria.php?id=<?php echo $row['idCategorias']; ?>" class="btn btn-outline-info"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-folder-plus" viewBox="0 0 16 16">
                                            <path d="m.5 3 .04.87a1.99 1.99 0 0 0-.342 1.311l.637 7A2 2 0 0 0 2.826 14H9v-1H2.826a1 1 0 0 1-.995-.91l-.637-7A1 1 0 0 1 2.19 4h11.62a1 1 0 0 1 .996 1.09L14.54 8h1.005l.256-2.819A2 2 0 0 0 13.81 3H9.828a2 2 0 0 1-1.414-.586l-.828-.828A2 2 0 0 0 6.172 1H2.5a2 2 0 0 0-2 2zm5.672-1a1 1 0 0 1 .707.293L7.586 3H2.19c-.24 0-.47.042-.683.12L1.5 2.98a1 1 0 0 1 1-.98h3.672z" />
                                            <path d="M13.5 10a.5.5 0 0 1 .5.5V12h1.5a.5.5 0 1 1 0 1H14v1.5a.5.5 0 1 1-1 0V13h-1.5a.5.5 0 0 1 0-1H13v-1.5a.5.5 0 0 1 .5-.5z" />
                                        </svg></td></a>
                                    <td>Niveles</td>
                                    <td><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-box-arrow-up-right" fill="currentColor" xmlns="http://www.w3.org/2000/svg">

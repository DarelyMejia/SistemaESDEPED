...
//recuperar id seleccionado en interfaz de subcategoria o rubro del instrumento 
$where = "";
...
$where = "WHERE idSubCategoria= '$idSubCategoria'";
$sql2 = "SELECT nombreSubCategoria FROM subcategoria $where";
$resultado2 = $mysqli->query($sql2);
$insidnew1 = mysqli_fetch_assoc($resultado2);
$nombreSubCategoria = $insidnew1["nombreSubCategoria"];

//Mostrar en tabla items cuyo id = id recuperado del rubro seleccionado de la convocatoria
$sql4 = "SELECT * FROM catalogosrubros WHERE idSubcategoria='$idSubCategoria'";
$resultado4 = $mysqli->query($sql4);

//LISTA subcategorias SELECT. Mostrar subcategorias cuyo id sea el recuperado del subcategorias
$sql = "SELECT idSubCategoria, nombreSubCategoria FROM subcategoria where idSubCategoria='$idSubCategoria'";
$result = $mysqli->query($sql);

//LISTA items SELECT. Mostrar subcategorias cuyo id sea el recuperado del subcategorias
$sqlS = "SELECT idCatalogosRubros, item FROM catalogosrubros where idSubcategoria='$idSubCategoria'";
...
<head>
    ...
    <script type="text/javascript">
        ...
        window.Muse.assets = {
            "required": ["museutils.js", "museconfig.js", "jquery.watch.js", "require.js", "_tems.css"],
            "outOfDate": []
        };
    </script>
    ...
    <link rel="stylesheet" type="text/css" href="css/_tems.css?crc=4264006283" id="pagesheet" />
</head>
...
<body>
    ...
    <div class="clearfix" id="page">
        ...
        <div class="position_content" id="page_position_content">
            ...
            <div class="browser_width colelem" id="u3682-bw">
                <div id="u3682">
                    ...
                    <div class="clearfix" id="u3682_align_to_page">
                        <div class="clearfix grpelem" id="u5212-4">
                            <!-- content -->
                            <p>Instrumento</p>
                        </div>
                    </div>
            ...
            <form class="form-horizontal" method="POST" action="guardar_items.php" autocomplete="off">
                <div class="clearfix colelem" id="u5218-4">
                    <!-- content -->
                    <p>Nombre del Rubro</p>
                </div>
                <div class="colelem" id="u5213">
                    <!-- custom html -->
                    <select name="nombreSubCategoria" class="btn btn-danger dropdown-toggle" size="0" id="nombreSubCategoria">
                        <option selected="selected">Seleccione SubCategoria</option>
                        <?php

                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                //echo "<option value=" . $row["idInstrumento"] . ">" . $row["nombre_instrumento"] . "</option>";
                                echo "<option value=" . $row["nombreSubCategoria"] . ">" . $row["nombreSubCategoria"] . "</option>";
                            }
                        } else {
                ...
                <div class="clearfix colelem" id="pu5214-4">
                    <!-- group -->
                    <div class="clearfix grpelem" id="u5214-4">
                        <!-- content -->
                        <p>ítem:</p>
                    </div>
                    <div class="clearfix grpelem" id="u5247-4">
                        <!-- content -->
                        <p>Definición:</p>
                    </div>
                </div>
                <div class="clearfix colelem" id="pu5242">
                    <!-- group -->
                    <div class="grpelem" id="u5242">
                        <!-- custom html -->
                        <textarea class="form-control" name="item" id="item" placeholder="Ingrese ítem"></textarea>
                    </div>
                    <div class="grpelem" id="u5248">
                        <!-- custom html -->
                        <textarea class="form-control" name="definicion" id="definicion" placeholder="Ingrese definición del ítem"></textarea>
                        <input class="form-control" name="idSubCategoria" id="idSubCategoria" value="<?php echo '' . $idSubCategoria; ?>" required>
                    </div>
                </div>
                <div class="clearfix colelem" id="u5255-4">
                    <!-- content -->
                    <p>Comprobante:</p>
                </div>
                <div class="clearfix colelem" id="pu5256">
                    <!-- group -->
                    <div class="grpelem" id="u5256">
                        <!-- custom html -->
                        <textarea class="form-control" name="definicionComprobante" id="definicionComprobante" placeholder="Ingrese comprobante del ítem"></textarea>
                    </div>
                    <div class="Button rounded-corners clearfix grpelem" id="buttonu5209">
                        <!-- container box -->
                        <button type="submit" class="Button rounded-corners clearfix colelem" id="buttonu4711">
                            <div class="clearfix grpelem" id="u5210-4">
                                <!-- content -->
                                <p>Agregar ítem</p>
                            </div>
                        </button>
            ...
            <form id="mt" action="<?php echo $_SERVER["PHP_SELF"] ?>?id=<?php echo $idSubCategoria; ?>" method="POST">
                <div class="clearfix colelem" id="u5284-4">
                    <!-- content -->
                    <p>Nombre del Ítem</p>
                </div>
                <div class="colelem" id="u5285">
                    <!-- custom html -->
                    <select name="nombreItem" class="btn btn-danger dropdown-toggle" size="0" id="nombreItem">
                        <option selected="selected">Seleccione ítem</option>
                        <?php
                ...
                <div class="clearfix colelem" id="u5292-4">
                    <!-- content -->
                    <p>Número de Puntaje / Unidad:</p>
                </div>
                <div class="clearfix colelem" id="pu5295">
                    <!-- group -->
                    <div class="grpelem" id="u5295">
                        <!-- custom html -->
                        <input type="text" class="form-control" placeholder="Ingrese número de puntaje / unidad a evaluar" id="cantidad" name="cantidad" form="mt">
                    </div>
                    <div class="Button rounded-corners clearfix grpelem" id="buttonu5306">
                        <!-- container box -->
                        <button type="submit" class="Button rounded-corners clearfix colelem" id="buttonu4711">
                            <div class="clearfix grpelem" id="u5307-4">
                                <!-- content -->
                                <p>Mostrar</p>
                            </div>
                    </div>
                ...
                <?php if (isset($_POST["cantidad"]) && is_numeric($_POST["cantidad"])) {
                    for ($i = 0; $i < $_POST["cantidad"]; $i++) { ?>
                        <div class="clearfix colelem" id="u5268-4">
                            <!-- content -->
                            <p>Puntaje / Unidad</p>
                        </div>
                        <div class="colelem" id="u5263">
                            <!-- custom html -->
                            <input type="text" placeholder="Clasificación (opcional)" class="form-control" name="clasificacion" id="clasificacion">
                        </div>
                        <div class="clearfix colelem" id="pu5271">
                            <!-- group -->
                            <div class="grpelem" id="u5271">
                                <!-- custom html -->
                                <input type="number" min="1" class="form-control" placeholder="Puntos" name="puntos" id="puntos">
                            </div>
                            <div class="clearfix grpelem" id="u5276-4">
                                <!-- content -->
                                <p>/</p>
                            </div>
                            <div class="grpelem" id="u5279">
                                <!-- custom html -->
                                <input type="text" class="form-control" placeholder="Unidad" name="unidad" id="unidad">
                            </div>
                        </div>
                        <?php include "guardar_puntositem.php" ?>
                <?php }
                } ?>
                <div class="Button rounded-corners clearfix colelem" id="buttonu5300">
                    <button type="submit" class="Button rounded-corners clearfix colelem" id="buttonu4711">
                        <!-- container box -->
                        <div class="clearfix grpelem" id="u5301-4">
                            <!-- content -->
                            <p>Agregar puntaje</p>
                        </div>
                    </button>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <?php while ($row = $resultado4->fetch_array(MYSQLI_ASSOC)) { ?>
                            <tr>
                                <td>
                                    <?php echo $row['idCatalogosRubros']; ?>
                                </td>
                                <td>
                                    <?php echo $row['item']; ?>
                                </td>
                                ...
                                <td>
                                    <?php echo $row['definicionComprobante']; ?>
                                </td>
                                <td>
                                    <?php echo $row['idSubcategoria']; ?>
                                </td>
                                <td><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-folder-plus" viewBox="0 0 16 16">

...
$sql = "SELECT * FROM expediente WHERE idExpediente = '$idExpediente'";
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/modificaciondocumento.css?crc=328875387" id="pagesheet" />
    ...
    <script type="text/javascript">
        ...
        window.Muse.assets = {
            "required": ["museutils.js", "museconfig.js", "jquery.watch.js", "require.js", "modificaciondocumento.css"],
            "outOfDate": []
        };
    </script>

    <title>ModificacionDocumento</title>
    <!-- CSS -->
...
<body>
    ...
    <div class="clearfix" id="page">
        ...
        <form class="form-horizontal" action="guardar_modificaciondocumento.php" method="POST" enctype="multipart/form-data" autocomplete="on" name="form">

            <div class="clearfix colelem" id="pu5020-4">
                <!-- group -->
                <div class="clearfix grpelem" id="u5020-4">
                    <!-- content -->
                    <p>Nombre</p>
                </div>
                <div class="clearfix grpelem" id="u5038-4">
                    <!-- content -->
                    <div class="form-group">
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="nombreExpediente" name="nombreExpediente" placeholder="Nombre" value="<?php echo $row['nombreExpediente'];?>"required>
                        </div>
                    </div>
                </div>
            </div>

            <div class="clearfix colelem" id="pu5021">
                <!-- group -->
                <div class="grpelem" id="u5021">
                    <!-- custom html -->
                ...
                <div class="Button rounded-corners clearfix grpelem" id="buttonu5022">
                    <input type="hidden" name=id value="<?php echo $idExpediente;?>" id= id >
                    <!-- container box -->
                    <button type="submit" class="Button rounded-corners clearfix colelem">
                        <div class="clearfix grpelem" id="u5023-4">
                            <!-- content -->
                            <p>Guardar</p>
                        </div>
                    </button>
